...
import { DashboardLayoutItem, DEFAULT_DASHBOARD_LAYOUT } from "./shared/dashboardLayout";

export { DashboardLayoutItem, WORKSPACE_PANEL_IDS, DEFAULT_DASHBOARD_LAYOUT } from "./shared/dashboardLayout";

export const CONFIG_VERSION = "0.2.4";
export const LOCATIONS_VERSION = "0.2.4";
export const POSTALS_VERSION = "0.3.2";
export const SETTINGS_VERSION = "1.7.1";
...
export type SettingsType = {
  ...
  /** Saved positions/sizes for each workspace panel, in react-grid-layout format. */
  dashboardLayout: DashboardLayoutItem[];
  /** Panel ids currently hidden from the workspace. */
  hiddenPanels: string[];
...
export type Ts3ServerProfile = {
  ...
  /** Civilian Business Communication - a sub-channel of the civilian area
   * where civilians can also place 911 calls from. */
  civilianBusinessChannelId?: string;
  losSantos911: string;
  losSantos311: string;
  ...
  ts3ServerProfiles: [
    {
      ...
      civilianBusinessChannelId: "26137",
      losSantos911: "26130",
      losSantos311: "26131",
    ...
    },
    {
      ...
      civilianBusinessChannelId: "3200",
      losSantos911: "13625",
      losSantos311: "13624",
    ...
    },
    {
      ...
      civilianBusinessChannelId: "26877",
      losSantos911: "26872",
      losSantos311: "26873",
